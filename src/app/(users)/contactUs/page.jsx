    ...
    return (
        ...
        <section className="container flex-between my-8">
             <div className="flex flex-col gap-y-5">
                ...
                <p className="leading-8">لطفا کالای مرجوعی خود را پس از ثبت در سایت و تایید نهایی توسط پشتیبان ، به این آدرس ارسال نمایید : استان گیلان ، شهرستان بندرانزلی , خیابان پنجم , نرسیده به دانشگاه علمی کاربردی , جنب مشاور املاک افشار , سالن ورزشی افشار ( ایواز پلاس ) کد پستی : 4319783333 شماره تماس جهت مرجوعی : 09352700860</p>
             </div>
