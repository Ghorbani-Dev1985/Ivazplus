  ...
  try {
    ...
    return ( 
        <>
         ...
         <form onSubmit={handleSubmit(CompleteProfileHandler)} className="w-full max-w-sm space-y-10 mb-8">
         <TextField label=" نام و نام خانوادگی" name="name" required register={register}  validationSchema={{
          ...
          errors={errors} ltr placeholder="لطفا ایمیل را وارد نمایید"/>
             <TextField label="ایمیل" name="email" required register={register}  validationSchema={{
