...
const CheckOTPForm = ({phoneNumber , onResendOtp , otpResponse , onBack}) => {
    ...
    const {isPending , error , data , mutateAsync : mutateCheckOtp} = useMutation({
      mutationFn: CheckOtp
    })
    ...
    return ( 
        <>
        <div className="absolute right-2 text-slate-500 hover:text-slate-600 transition-colors">
         <button onClick={onBack} className="flex-center">
